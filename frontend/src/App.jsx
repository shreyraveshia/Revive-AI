...
const initialRecoveryForm = {
  transaction_id: "95d62391-d441-424c-bd92-a67059fe2185",
  amount_paise: 250000,
  payment_method: "upi",
...
function App() {
  ...
  async function executeRecovery() {
    ...
    if (decision.selected_action !== "payment_link") {
      return;
    }
    ...
    try {
      const response = await fetch(`${API_BASE}/api/recovery/execute`, {
        ...
        body: JSON.stringify({
          recovery_action_id: decision.recovery_action_id,
          amount_paise: Number(form.amount_paise),
          reference_id: `REVIVE-${decision.transaction_id.slice(0, 24)}`,
          description: "Revive AI revenue recovery",
        }),
      });

      if (!response.ok) {
        const body = await response.json().catch(() => null);
        throw new Error(body?.detail || "Recovery execution failed");
      }
          ...
          <div className="panel">
            ...
            >
              ...
              <div className="field">
                ...
                >
                  <option value="upi_timeout">
                    UPI timeout
                  </option>

                  <option value="upi_declined">
                    UPI declined
                  </option>
                  ...
                  <option value="soft_decline">
                    Soft decline
                  </option>

                  <option value="hard_decline">
                    Hard decline
                  </option>
              ...
              <div className="decision-content">
                <div className="recommendation">
                  ...
                  <div className="recommendation-action">
                    {decision.selected_action.replace(
                      "_",
                      " ",
                    )}
                  </div>
                  ...
                  <div className="recommendation-reason">
                    {decision.decision_reason.replaceAll(
                      "_",
                      " ",
                    )}
                  </div>
                  ...
                  {canExecutePaymentLink ? (
                    ...
                    <>
                      <p>
                        ...
                        . This action is simulation-only
                        in Revive and will not trigger
                ...
                <div className="message-box">
                  ...
                  <p>
                    {decision.diagnosis.customer_message}
                  </p>
                </div>
              </div>
            )}
                ...
                <tbody>
                  {actions.map((item) => (
                    <tr key={item.action_id}>
                      ...
                      <td>
                        {(
                          item.expected_recovery_probability *
                          100
                        ).toFixed(1)}
                        %
                      </td>
